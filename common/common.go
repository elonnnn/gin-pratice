...
func CreateSign(params url.Values) string {
	...
	// 自定义签名算法
	sign := MD5(MD5(str) + MD5(global.GVA_VP.GetString("app.name")+global.GVA_VP.GetString("app.secret")))
	return sign
}
...
func VerifySign(c *gin.Context) {
	...
	exp, _ := strconv.ParseInt(global.GVA_VP.GetString("app.expired"), 10, 64)
