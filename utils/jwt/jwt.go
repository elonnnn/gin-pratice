...
func NewJWT() *JWT {
	return &JWT{
		[]byte(global.GVA_VP.GetString("jwt.signing-key")),
	}
}

func (j *JWT) CreateClaims(baseClaims BaseClaims) CustomClaims {
	bf, _ := utils.ParseDuration(global.GVA_VP.GetString("jwt.buffer-time"))
	...
	claims := CustomClaims{
		...
		StandardClaims: jwt.StandardClaims{
			...
			Issuer:    global.GVA_VP.GetString("jwt.issuer"), // 签名的发行者
		},
	}
	return claims
}
